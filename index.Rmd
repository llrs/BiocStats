...
We first join them to work easier and compare between them.
...
It seems that Software packages are as much downloaded as Experimental data and Annotations are less downloaded.  
However, there are some packages are erroniously classified in several categories as you can see if we calculate the overlap between packages:
```{r intersect}
